use utf8;
package Prep::Schema::Result::QuickReplyLog;
...
=head1 TABLE: C<quick_reply_log>

=cut

__PACKAGE__->table("quick_reply_log");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tkgwOEhzu3wvenpqPI9VEQ
